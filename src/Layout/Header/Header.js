...
//                     return <NavLink className = { `${active} nav-link` }
//                     id = "all"
//                     onClick = { this.changeKind }
//                     exact to = '/course/all' > Course < /NavLink>
//                 }
//             }
//             />
//         )
...
//     renderSignIn = () => {
//         return ( <
//             Popup className = "mx-auto modalLogin"
//             modal trigger = { < li className = "nav-item" >
//                 <
//                 button className = "nav-link" > Login < /button> </li >
//             } > <
//             Login / >
//             <
//             /Popup>
...
//                     SignUp / >
//                     <
//                     p className = "text-center" > Already have account ? < span onClick = {
//                         () => this.renderSignIn()
//                     }
...
//                     <
//                     NavLink to = "/"
//                     exact className = "navbar-brand" > Cour < span className = "brand" > sea < /span></NavLink >
//                     <
...
//                     <
//                     span > < i className = "fa fa-shopping-cart" > < /i></span > { cart.length > 0 ? < span className = "quantity" > { cart.length } < /span> : <span></span > } <
//                     /NavLink> {
//                     this.state.hover &&
//                     <
...
//             li > <
//                 li className = "nav-item" > { this.renderLink() } <
//                 /li> <
//             li className = "nav-item" >
//                 <
//                 NavLink to = "/about"
...
//                 div className = "userOption" > { this.renderSignIn() } { this.renderSignUp() } <
//                 /div>
//             )
//         } <
//         /ul> < /
